...
static const struct target_entry g_targets[] = {
  {
    .label = "Fire OS 8.1.8.2 (RS8182.3811N / 0032548774788)",
    .device_match = "karat",
    .banner_match = "-g76bdd754c12c",
    .fp_match = "RS8182.3811N",
    .ksym = {
  ...
  {
    .label = "Fire OS 8.1.8.0 (RS8180.3729N / 0032280318208)",
    .device_match = "karat",
    .banner_match = "-g76bdd754c12c",
    .fp_match = "RS8180.3729N",
    .ksym = {
      .kimage_text_base = 0xffffffc010000000ULL,
  ...
  {
    .label = "Fire OS 8.1.7.4 (RS8174.3648N / 0031877644288)",
    .device_match = "karat",
    .banner_match = "-ge1cb3cb5ad98",
    .fp_match = "RS8174.3648N",
    .ksym = {
      .kimage_text_base = 0xffffffc010000000ULL,
      .random_misc_fops_off = 0x016d7558ULL,
      .ashmem_misc_fops_off = 0x01be0c10ULL,
      .ashmem_fops_off = 0x0173f420ULL,
      .ashmem_ioctl_off = 0x0101e53cULL,
      .ashmem_compat_ioctl_off = 0x0101e5dcULL,
      .ashmem_mmap_off = 0x0100fd14ULL,
      .ashmem_open_off = 0x0101af28ULL,
      ...
      .empty_zero_page_off = 0x01c61000ULL,
      .root_task_group_off = 0x01c67b80ULL,
      .selinux_blob_sizes_off = 0x017a3300ULL,
      .selinux_enforcing_off = 0x01ca12f8ULL,
      .security_hook_heads_off = 0x017a2c70ULL,
      .kmalloc_caches_off = 0x017a27d0ULL,
      .anon_pipe_buf_ops_off = 0x015db860ULL,
      .slide_random_boot_id_data_off = 0x01b40580ULL,
      .slide_sysctl_bootid_off = 0x01cd2a94ULL,
      .slide_loggers_0_1_off = 0x01a3e330ULL,
      .slide_nfulnl_logger_off = 0x01a3e400ULL,
  ...
  {
    .label = "Fire OS 8.1.7.4 (RS8174.3641N / 0031877642496)",
    .device_match = "karat",
    .banner_match = "-ge1cb3cb5ad98",
    .fp_match = "RS8174.3641N",
    .ksym = {
      .kimage_text_base = 0xffffffc010000000ULL,
      .random_misc_fops_off = 0x016d7558ULL,
      .ashmem_misc_fops_off = 0x01be0c10ULL,
  ...
  {
    .label = "Fire OS 8.1.6.9 (RS8169.3556N / 0031139423232)",
    .device_match = "karat",
    .banner_match = "-ge1cb3cb5ad98",
    .fp_match = "RS8169.3556N",
    .ksym = {
      .kimage_text_base = 0xffffffc010000000ULL,
      .random_misc_fops_off = 0x016d7558ULL,
      .ashmem_misc_fops_off = 0x01be0c10ULL,
